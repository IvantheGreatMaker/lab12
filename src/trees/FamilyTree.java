...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0) {
			throw new TreeException("Invalid Colon Position"); // a TreeException with a useful message
		}
		...
		for(String childName: childrenArray) {
			TreeNode epic = new TreeNode(childName);
			parentNode.children.add(epic);
		}
	}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node2 == null)
			throw new TreeException("name2 does not exist");
